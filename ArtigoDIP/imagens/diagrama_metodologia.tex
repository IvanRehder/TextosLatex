...
\begin{tikzpicture}[node distance = 3cm]
    ...
    \node (pergunta) [start, below of=leitura, yshift = 1.0cm] {Respostas a pergunta de pesquisa};
    ...
    \draw [arrow] (wos) to ++(0,-1.25cm) node[text width=2.5cm, color = black, above right]{4 artigos} to ++(-2.5cm,0) to node[text width=2.5cm, right, color = black]{52 artigos} (categoria.north);        
    ...
    \draw [arrow] (leitura) to ++(0,-1.25cm) node[text width=2.5cm, color = black, above right]{7 artigos} to node[midway,above right]{} (pergunta.north);
